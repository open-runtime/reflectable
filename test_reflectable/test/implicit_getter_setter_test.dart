...
class Reflector extends Reflectable {
  const Reflector() : super(declarationsCapability, const InvokingCapability('f'));
}
...
void main() {
  ...
  test('implicit getter properties', () {
    ...
    expect(f1GetterMirror.qualifiedName, 'test_reflectable.test.implicit_getter_setter_test.A.f1');
    ...
    expect(f2getterMirror.qualifiedName, 'test_reflectable.test.implicit_getter_setter_test.A.f2');
    ...
    expect(f3GetterMirror.qualifiedName, 'test_reflectable.test.implicit_getter_setter_test.A.f3');
    ...
    expect(f4GetterMirror.qualifiedName, 'test_reflectable.test.implicit_getter_setter_test.A.f4');
    ...
    expect(f5GetterMirror.qualifiedName, 'test_reflectable.test.implicit_getter_setter_test.A.f5');
  ...
  test('implicit setter properties', () {
    ...
    expect(f1SetterMirror.qualifiedName, 'test_reflectable.test.implicit_getter_setter_test.A.f1=');
    ...
    expect(f3SetterMirror.qualifiedName, 'test_reflectable.test.implicit_getter_setter_test.A.f3=');
