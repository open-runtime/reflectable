...
@GlobalQuantifyCapability(r'^test_reflectable.test.global_quantify_test.(A|B)$', reflector)
...
class Reflector extends Reflectable {
  const Reflector() : super(typeCapability, const InstanceInvokeCapability('foo'));
}
