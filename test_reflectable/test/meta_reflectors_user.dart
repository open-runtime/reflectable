...
void runTests() {
  ...
  test('MetaReflector, set of reflectors', () {
    ...
    expect(
        getNames(const ScopeMetaReflector().reflectablesOfScope('polymer')), {'Reflector', 'ReflectorUpwardsClosed'});
    expect(
        getNames(const ScopeMetaReflector().reflectablesOfScope('observe')), {'Reflector2', 'ReflectorUpwardsClosed'});
  });
  ...
  test('MetaReflector, select by name', () {
    var reflector2 = reflectors.firstWhere((Reflectable reflector) => '$reflector'.contains('2'));
