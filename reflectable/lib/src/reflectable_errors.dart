...
const String metadataNotDirectSubclass = 'Metadata has type Reflectable, but is not an instance of '
...
/// a non-class type.
const String superArgumentNonClass = 'The super constructor invocation receives an argument whose'
...
const String superArgumentWrongLibrary = 'The super constructor invocation receives an argument whose'
    ' type `{element}` is defined outside the library `{library}`.';

/// It is a transformation time error to give an argument to the super
/// constructor invocation in a subclass of Reflectable that is non-const.
const String superArgumentNonConst = 'The super constructor invocation receives an argument'
